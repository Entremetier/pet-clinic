...
public class OwnerController {
    ...
    //verhindert das beim eintragen der werte jemand ein neues formular erstellt und die id einträgt um so die datenbank
    //zu hacken. Wird aus securitygründen hinzugefügt
    @InitBinder
